	...
	return (
		<header className="flex items-center h-14 bg-white border-b border-slate-200 shadow-sm px-4 sticky top-0 z-40">
			...
			<nav className="flex items-center gap-1">
				<Link
					to="/feed"
					className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-slate-600 hover:text-sky-700 hover:bg-sky-50 rounded-lg transition"
				>
					<span
				...
				<button
					onClick={logout}
					className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition cursor-pointer"
				>
					<span
						className="material-symbols-outlined"
						style={{ fontSize: "1.35rem" }}
